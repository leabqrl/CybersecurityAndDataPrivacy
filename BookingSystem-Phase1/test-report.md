...
2.  Add X-Frame-Options or CSP frame-ancestors to prevent clickjacking
3.  Implement CSRF protection tokens across all forms
4.  Add a strict Content-Security-Policy header
...
| F-04 | 🟠 Medium |Content Security Policy (CSP) Header Not Set | CSP is an added layer of security that helps to detect and mitigate certain types of attacks, including Cross Site Scripting (XSS) and data injection attacks. | <img width="611" height="314" alt="Capture d&#39;écran 2025-11-28 175135" src="https://github.com/user-attachments/assets/78298be7-9e80-49a8-b3e0-7f98322c3cb4" /> |
